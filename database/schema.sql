-- Core Database Schema for Maxed Homes Property Rental System
...
CREATE TABLE bookings (
    ...
    CONSTRAINT valid_guest_count CHECK (guests_count <= (
        SELECT max_guests FROM properties WHERE id = property_id
    )),
